...
func SetupRouter(
	...
	// 应用中间件
	r.Use(middleware2.RequestLoggerWithProfiling(cfg.Gateway.RequestProfilingEnabled, cfg.Gateway.RequestProfilingGroupIDs...))
	r.Use(middleware2.TeamoRelayIngress(cfg))
	...
	r.Use(middleware2.LoggerWithProfiling(cfg.Gateway.RequestProfilingEnabled))
